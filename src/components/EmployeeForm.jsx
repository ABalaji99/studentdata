...

          {
            inputAlert&&(
              inputValues.name.length === 0 ? (
                <p className="color-red">Name should not contain "@1234567890"</p>
              ) : (
...

{
            inputAlert&&(
              inputValues.phone.length === 0 ? (
                <p className="color-red">Please Enter Phone Number</p>
              ) : (
                inputValues.phone.length<=9?<p className="color-red">Phone Number should contain 10 numbers</p>:<p className="color-green">Phone number is correct</p>
              )
            )
           }
          </div>
